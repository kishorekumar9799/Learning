...
export default function StatsBar({ stats }: StatsBarProps) {
  const statItems = [
    {
      ...
      icon: Users,
      color: 'text-[#0a2540] bg-blue-50 dark:bg-blue-950/30 dark:text-sky-350'
    },
    {
      id: 'ranking',
    ...
    },
    {
      ...
      icon: Landmark,
      color: 'text-blue-700 bg-blue-100/40 dark:bg-[#0a2540]/30 dark:text-sky-300'
    },
    {
      id: 'placements',
  ...
  return (
    <section className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 md:-mt-20 mb-16">
      <div className="bg-[#fdfcfb] dark:bg-[#0a1220]/70 border border-[#0a2540]/10 dark:border-blue-900/20 rounded-2xl shadow-xl shadow-blue-950/5 divide-y md:divide-y-0 md:divide-x divide-blue-950/5 dark:divide-blue-900/20 grid grid-cols-1 md:grid-cols-4 overflow-hidden">
        {statItems.map((item, idx) => {
          ...
          return (
            <motion.div 
              ...
              className="p-6 md:p-8 flex flex-col items-center text-center group cursor-default transition-all hover:bg-blue-50/20 dark:hover:bg-blue-950/10 select-none"
            >
              ...
              <div className="font-serif text-3xl md:text-4xl font-bold text-[#0a2540] dark:text-[#f1f5f9] mb-1.5 font-mono">
                {item.value}
              </div>
              ...
              <div className="text-xs text-slate-400 dark:text-sky-400/40 font-mono">
                {item.description}
              </div>
            </motion.div>
          );
